...
import { lohagadFortLocations as staticLocs, lohagadGraphEdges as staticEdges, lohagadFortMetadata as staticMeta } from '../../data/lohagadFortData.js';
...
import { LOHAGAD_CENTER } from '../../data/lohagadLocations.js';

// Lazy-load Leaflet map to avoid bundle bloat on first render
const LohagadLeafletMap = lazy(() => import('./LohagadLeafletMap'));
...
const LohagadSmartExplorationPage = ({ onBack }) => {
...
export default LohagadSmartExplorationPage;
