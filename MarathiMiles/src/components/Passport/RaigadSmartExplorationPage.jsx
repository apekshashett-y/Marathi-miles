...
const RaigadLeafletMapView = lazy(() => import("./RaigadLeafletMap"));

// SVG coordinate space dimensions
const SVG_W = 1000;
const SVG_H = 800;

const RaigadSmartExplorationPage = ({ onBack }) => {
    const navigate = useNavigate();
    const fortGraph = fortGraphs["raigad"];
    const fortName = fortGraph?.fortName || "Raigad Fort";
    ...
    const handleNodeClick = (nodeId) => {
        if (nodeId) {
            trackLocationClick("raigad", nodeId);
        }
    };
        ...
        <div className="smart-exploration-page">
                ...
                <div className="exploration-header-content">
                    ...
                    <div className="exploration-header-controls">
                        ...
                        <span className="raigad-ai-badge">
                            AI Confidence: {optimizedPlan ? '68%' : '...'}
                        </span>
            ...
            <div className="exploration-main-content">
                <div className="exploration-left-panel">
                    ...
                    <div className="control-section">
                        <label className="control-label"><span className="label-icon">🔥</span> TIME BUDGET: {timeOptions.find(t => t.value === timeAvailable)?.minutes}M</label>
                ...
                <div className="exploration-center-map">
                    {mapMode === 'illustrated' ? (
                        ...
                        <Suspense fallback={
                            ...
                            <RaigadLeafletMapView optimizedPath={optimizedPlan?.path || []} />
                        </Suspense>
                    )}
                    {mapMode === 'illustrated' && (
                    ...
                    {optimizedPlan ? (
                        <>
                            <div className="plan-header">
                                <h3 className="plan-title">Plan Your Adventure</h3>
                                <p className="raigad-plan-subtitle">Select your time and energy preferences to generate a personalized route.</p>
                                <div className="plan-stats">
                                    ...
                                    <div className="stat-item">
                                        ...
                                        <div className="stat-content">
                                            <span className="stat-value">{totalWalkTime} min</span>
                                    ...
                                    <div className="stat-item">
                                        ...
                                        <div className="stat-content">
                                            ...
                                            <span className="stat-label">Places Covered</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div key={index} className="sequence-item">
                                        ...
                                        <div className="sequence-content">
                                            ...
                                            <div className="sequence-meta">
                                                ...
                                                {stop.walkTime > 0 && <span className="meta-badge meta-badge-walk">🚶 {stop.walkTime} min walk</span>}
                                            </div>
                                        </div>
                                    </div>
                                ))}
                            ...
                            <div className="alternative-routes">
                                <h4 className="alternatives-title">Recommended Route</h4>
                                <div className="raigad-route-summary">
                                    {optimizedPlan.path.map((stop, i) => (
                                        <span key={i} className="raigad-route-step">
                                            {stop.node.name}
                                            {i < optimizedPlan.path.length - 1 && <span className="raigad-route-arrow"> → </span>}
                                        </span>
                                    ))}
                                </div>
                            </div>
            ...
            {showAnalytics && (
                <div className="analytics-panel-container">
                    <AdaptiveAnalytics fortId="raigad" fortGraph={fortGraph} />
                </div>
            )}
        </div>
    );
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// 🏰 RAIGAD ILLUSTRATED FORT MAP — Geo-projected SVG visualization
// All node positions derived from lat/lng via geoProjection utility.
// Dark theme with the same animation system as Shivneri.
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

const RaigadFortMapVisualization = ({ fortGraph, optimizedPath, onNodeClick }) => {
    ...
    // Convert all nodes from lat/lng to SVG coordinates using Raigad bounds
    const nodePositions = {};
    ...
    return (
        <svg viewBox="0 0 1000 800" className="fort-map-svg raigad-map-svg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
            <defs>
                <filter id="raigad-shadow"><feDropShadow dx="0" dy="4" stdDeviation="6" floodOpacity="0.3" /></filter>
                <filter id="raigad-card-shadow"><feDropShadow dx="0" dy="4" stdDeviation="12" floodOpacity="0.2" /></filter>
                <filter id="raigad-glow">
                    <feGaussianBlur stdDeviation="3" result="blur" />
                    <feMerge><feMergeNode in="blur" /><feMergeNode in="SourceGraphic" /></feMerge>
                </filter>
                {/* Dark fort terrain gradient */}
                <radialGradient id="raigadTerrainGrad" cx="50%" cy="50%" r="60%">
            ...
            {/* Fort boundary silhouette — dark theme */}
            <path
                d="M 150,680 Q 60,460 220,240 Q 430,100 700,160 Q 960,240 910,540 Q 820,800 460,760 Q 240,710 150,680 Z"
                fill="url(#raigadTerrainGrad)" stroke="#3a3a3a" strokeWidth="2" opacity="0.85"
            />
                    ...
                    <g key={index}>
                        ...
                        {isPart && (
                            <line
                                ...
                                filter={isActive ? "url(#raigad-glow)" : "none"}
                                style={{
                ...
                return (
                    ...
                    >
                        ...
                        <circle
                            ...
                            filter={isInPath ? "url(#raigad-shadow)" : "none"}
                        />
                        ...
                        {!isInPath && (
                            <>
                                ...
                                {node.name.includes('(') || node.description ? null : null}
                            </>
                        )}

                        {/* ━━━ Hover Tooltip ━━━ */}
                        {isHovered && (
                            <g className="raigad-tooltip-group">
                                {(() => {
                                    const tooltipW = 220;
                                    const tooltipH = 100;
                                    let tx = pos.x + 25;
                                    ...
                                    return (
                                        <>
                                            ...
                                            <rect x={tx + 12} y={ty + 72} width={180} height="4" fill="#333" rx="2" />
                                            <rect x={tx + 12} y={ty + 72} width={(node.historicalImportance / 10) * 180} height="4" fill="#e08d55" rx="2" />
                                            <rect x={tx + 12} y={ty + 84} width={180} height="4" fill="#333" rx="2" />
                                            <rect x={tx + 12} y={ty + 84} width={(Math.min(node.visitTime * 4, 100) / 100) * 180} height="4" fill="#666" rx="2" />
                                        </>
                                    );
                                })()}
                            </g>
            ...
            <text x={SVG_W - 10} y={SVG_H - 8} fontSize="9" fill="#555" textAnchor="end" opacity="0.6">
                Geo-projected from real lat/lng • Raigad Fort
            </text>
        </svg>
    );
};

export default RaigadSmartExplorationPage;
