...
import { pratapgadFortLocations as staticLocs, pratapgadGraphEdges as staticEdges, pratapgadFortMetadata as staticMeta } from '../../data/pratapgadFortData.js';
...
import { PRATAPGAD_CENTER } from '../../data/pratapgadLocations.js';

// Lazy-load Leaflet map to avoid bundle bloat on first render
const PratapgadLeafletMap = lazy(() => import('./PratapgadLeafletMap'));
...
const PratapgadSmartExplorationPage = ({ onBack }) => {
    ...
    const [lastLocationId, setLastLocationId] = useState('mainGate');
...
export default PratapgadSmartExplorationPage;
