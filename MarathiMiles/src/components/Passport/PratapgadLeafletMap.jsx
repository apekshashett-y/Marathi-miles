 ...
 * Real-world map rendering of Pratapgad Fort using OpenStreetMap tiles.
 * Uses real lat/lng from pratapgadLocations.js — no pixel values.
 */
...
import { pratapgadLocations, PRATAPGAD_CENTER } from "../../data/pratapgadLocations";
    ...
    useEffect(() => {
        ...
        const updateMarker = () => {
            ...
            if (stop.node && typeof stop.node.lat === 'number' && typeof stop.node.lng === 'number') {
                ...
                const loc = pratapgadLocations.find(l => l.id === stop.node.id);
 ...
 */
export default function PratapgadLeafletMap({ optimizedPath = [], simState = {} }) {
    ...
    return (
        ...
        .pratapgad-popup-desc {
          font-size: 12px;
          color: rgba(255,255,255,0.75);
          line-height: 1.4;
          margin: 0 0 8px;
        }
        .pratapgad-popup-badges {
          display: flex;
          gap: 6px;
          flex-wrap: wrap;
        }
        .pratapgad-popup-badge {
      ...
      `}</style>
            ...
            <MapContainer
                center={[PRATAPGAD_CENTER.lat, PRATAPGAD_CENTER.lng]}
                zoom={16}
                ...
                {pratapgadLocations.map((loc) => {
                    ...
                    return (
                        ...
                        >
                            <Popup>
                                <div>
                                    <p className="pratapgad-popup-title">
                                        {loc.icon} {loc.fullName}
                                    </p>
                                    <p className="pratapgad-popup-desc">{loc.description}</p>
                                    <div className="pratapgad-popup-badges">
                                        <span className="pratapgad-popup-badge">
                                            ⏱ {loc.visitTime} min
                                        </span>
                                        <span className="pratapgad-popup-badge">
                                            ★ {loc.importance}/10
                                        ...
                                        {isInPath && (
                                            <span className="pratapgad-popup-badge route">
                                                #{pathIdx + 1} on route
                                            </span>
                                        )}
                                    </div>
